...
param digitalSignageContentBrokerImage string = 'cracalzaawi36ptestsseus.azurecr.io/wmata/digital-signage-content-broker:1.0.1'
param containerAppsEnvironmentId string
param containerRegistryUserAssignedIdentityId string

param digitalSignageKioskApp string = 'digital-signage-kiosk-app'
param digitalSignageKioskAppImage string = 'cracalzaawi36ptestsseus.azurecr.io/wmata/digital-signage-kiosk-app:1.0'

param digitalSignageStationsAheadApp string = 'digital-signage-stations-ahead'
param digitalSignageStationsAheadAppImage string = 'cracalzaawi36ptestsseus.azurecr.io/wmata/digital-signage-stations-ahead-app:1.0'
