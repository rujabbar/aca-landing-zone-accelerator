...
param digitalSignageKioskAppImage string = 'dsscontainerregistrydev.azurecr.io/wmata/digital-signage-kiosk-app:1.0'

param digitalSignageStationsAheadApp string = 'digital-signage-stations-ahead'
param digitalSignageStationsAheadAppImage string = 'dsscontainerregistrydev.azurecr.io/wmata/digital-signage-stations-ahead-app:1.0'
